...
int main()
{
	...
	Shader lightingShader("gl_04.vert", "gl_04.frag");
	Shader lampShader("gl_04.vert", "gl_04.frag");
	...
	unsigned char* image;
	// Diffuse map
	image = SOIL_load_image("weiti.png", &width, &height, 0, SOIL_LOAD_RGB);
	...
	// Specular map
	image = SOIL_load_image("iipw.png", &width, &height, 0, SOIL_LOAD_RGB);
