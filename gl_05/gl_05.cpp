...
int main()
{
	try
	{
		...
		GLfloat pilarH = 2.0f;
		GLfloat pilarZ = 1.2f;
		GLfloat pilarThickness = 0.2f;
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, box, metal,
			glm::scale(glm::translate(glm::mat4(), glm::vec3(pilarX, pilarH / 2.f, pilarZ)), glm::vec3(pilarThickness, pilarH, pilarThickness)))));
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, box, metal,
			glm::scale(glm::translate(glm::mat4(), glm::vec3(pilarX, pilarH / 2.f, -pilarZ)), glm::vec3(pilarThickness, pilarH, pilarThickness)))));
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, box, metal,
			glm::scale(glm::translate(glm::mat4(), glm::vec3(-pilarX, pilarH / 2.f, pilarZ)), glm::vec3(pilarThickness, pilarH, pilarThickness)))));
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, box, metal,
			glm::scale(glm::translate(glm::mat4(), glm::vec3(-pilarX, pilarH / 2.f, -pilarZ)), glm::vec3(pilarThickness, pilarH, pilarThickness)))));
		//beams
		GLfloat beemThickness = 0.2f;
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, box, metal,
			glm::scale(glm::translate(glm::mat4(), glm::vec3(pilarX, pilarH - beemThickness / 2.f, 0.0f)),
				glm::vec3(beemThickness, beemThickness, pilarZ * 2 - pilarThickness)))));
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, box, metal,
			glm::scale(glm::translate(glm::mat4(), glm::vec3(-pilarX, pilarH - beemThickness / 2.f, 0.0f)),
				glm::vec3(beemThickness, beemThickness, pilarZ * 2 - pilarThickness)))));
		...
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, sawPlate, metal,
			glm::translate(glm::mat4(), glm::vec3(sawX, sawH + sawPlateHeight / 2.f, .0f)),
		...
		sceneElements.push_back(move(make_unique<SceneElement>(sceneShader, saw, metal,
			glm::translate(glm::mat4(), glm::vec3(sawX, sawH, 0.0f)),
			move(make_unique<SawingAnimation>(animationTime, startCuttingTime, startSplitingTime, swings)))));
		//logs
